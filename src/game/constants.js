...
export const MOVE_TEXT = {
  A: "手番を使い、自分と好きな駒2つ(敵味方どちらでも)の位置をランダムに入れ替える。選んだ2つが両方とも味方なら、入れ替え後の3つが作る三角形の内側(辺の上も含む)にいる相手の駒を取る。",
  2: "縦横1マス。",
  3: "斜め1マス。",
  4: "縦横に2マスまで。",
  5: "斜めに2マスまで。",
...
export const KING_TEXT = {
  ...
  4: "王以外の4の移動距離が「採用した4の枚数×2マス」伸びる(1枚なら4マス、3枚なら8マス)。王自身は2マスのまま(図は伸びた4)。王以外の4が倒されると、倒した相手を道連れにする。",
  5: "王以外の5の移動距離が「採用した5の枚数×2マス」伸びる(1枚なら4マス、3枚なら8マス)。王自身は2マスのまま(図は伸びた5)。王以外の5が倒されると、倒した相手を道連れにする。",
