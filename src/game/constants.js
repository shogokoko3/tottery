...
export const KING_TEXT = {
  ...
  2: "移動距離が「盤に出した2の枚数(倒れた駒も数える)」分伸びる。王の2が倒されると、盤に出した2が王位を継ぐ(複数なら選択)。",
  3: "移動距離が「盤に出した3の枚数(倒れた駒も数える)」分伸びる。王の3が倒されると、盤に出した3が王位を継ぐ(複数なら選択)。",
  4: "移動距離が「盤に出した4の枚数(倒れた駒も数える)」分伸びる。王以外の4が倒されると、倒した相手を道連れにする。",
  5: "移動距離が「盤に出した5の枚数(倒れた駒も数える)」分伸びる。王以外の5が倒されると、倒した相手を道連れにする。",
