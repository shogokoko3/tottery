...
export const AREA_INFO = Object.freeze({
  ...
  forest: {
    name: "森のエリア",
    text: "毎手番の初めに自動発動。相手の王以外で、正体を知らない駒をランダムで最大2体見抜く。対象と正体は自分だけに表示。",
    usesTurn: false,
    needsPiece: false,
  },
  ice: {
  ...
  sky: {
    name: "空のエリア",
    text: "毎手番の初めに任意発動。自分の1体(王・10以外)を10に変身・公開。以後、自軍の10は選んだ同じ1体を2回動かせる。発動後も移動できる。",
    usesTurn: false,
    needsPiece: true,
  },
  palace: {
    name: "宮殿",
    text: "毎手番の初めに任意発動。自分の1体(王・A・K以外)を1段階昇格・公開。自分は1試合に1回だけ2段階も選べる。Kが上限。発動後も移動できる。",
    usesTurn: false,
    needsPiece: true,
  },
});
