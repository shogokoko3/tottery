...
const EP13 = {
  ...
  steps: [
    ...
    {
      at: myTurn,
      text: "4♠ が 10 になり、表向きに。「空」の印が付きます。変身後も移動でき、以後はあなたの10のうち選んだ同じ1体を1手番に2回動かせます。",
      focus: { pieces: ["t1"] },
    },
    {
    ...
    {
      at: myTurn,
      text: "相手の番に、氷のエリアが自動で働きました。あなたの d1 の 2♠ が凍り、あなたの3ターンのあいだ動けません。再び選ばれると残り期間に3手番追加されます。",
      focus: { pieces: ["t2"] },
    },
    {
    ...
    {
      at: atEnd,
      text: "エリアは毎回の自分の手番の初めに1回まで。土・森・氷は対象がいれば自動、海・空・宮殿は任意です。どれも発動後に移動できます。詳しくはルール画面の「盤面エリア」へ。",
      end: true,
    },
  ],
};
