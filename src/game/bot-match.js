 ...
 * ランダムマッチの練習相手(Bot)。
 *
 * 持ち点が BOT_UNTIL_RATING(1750)に届くまでは、ランダムマッチで人と組まず、
 ...
 *
 * 決まり:
 *  - 1750 未満でも、まず掲示(人)で探す。人が見つからないまま BOT_WAIT_MS 経ったら Bot に切り替える
 *  - 直前のランダムマッチで人に負けていたら、次は探さずにすぐ Bot(1敗したら Bot)。Bot 戦を1局すると元に戻る
 *  - 1750 以上になった瞬間から、Bot は出ない(人だけ)
 *  - Bot との 9×9 は持ち点に数える(人との対局と同じ Elo)。だから勝てば 1750 に届く
...
/** この持ち点に届くまで Bot と組む */
export const BOT_UNTIL_RATING = 1750;
